...
const Index = () => {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="px-4 py-24 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg opacity-30 blur-xl"></div>
              <img 
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-6 hover:shadow-lg transition-shadow bg-gradient-to-br from-white to-blue-50">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow bg-gradient-to-br from-white to-purple-50">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow bg-gradient-to-br from-white to-indigo-50">
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="container mx-auto max-w-6xl text-center">
          <h2 className="text-3xl font-bold mb-12">Investasi untuk Masa Depanmu</h2>
          <div className="max-w-md mx-auto">
            <Card className="p-8 transform hover:scale-105 transition-all duration-300 bg-white/80 backdrop-blur">
              <img 
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold text-center mb-12">Testimoni Kontributor</h2>
